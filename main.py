...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        lable_tel = tk.Label(self, text = 'Телефон')
        lable_tel.place(x=50, y=60)
        lable_email = tk.Label(self, text = 'E-mail')
        lable_email.place(x=50, y=90)
        lable_salary = tk.Label(self, text = 'Зарплата')
        lable_salary.place(x=50, y=120)

        self.entry_name = tk.Entry(self)
        self.entry_name.place(x=200, y=30)
        self.entry_tel = tk.Entry(self)
        self.entry_tel.place(x=200, y=60)
        self.entry_email = tk.Entry(self)
        self.entry_email.place(x=200, y=90)
        self.entry_salary = tk.Entry(self)
        self.entry_salary.place(x=200, y=120)

        self.btn_ok = tk.Button(self, text = 'Добавить нового сотрудника')
